...
def ai_rewrite_achievement(text):
    ...
    elif "jaga" in clean or "warung" in clean or "toko" in clean or "kasir" in clean:
...
async def handle_message(message: types.Message):
    ...
    # Recovery state dari DB jika memori bot ter-reset/restart
    ...
    if step < TOTAL_STEPS:
        ...
        file_path = None
        try:
            file_path = create_cv_docx(user_id, state["data"])
