...
# Knowledge Base Internal Fallback (Persona Om Budi)
KNOWLEDGE_RULES = {
    "hutang": (
    ...
    "belum lunas": (
        ...
        "Jangan putus asa ya 😊, pertolongan Allah sering kali hadir tepat saat batin kita benar-benar pasrah dan berhenti menuntut 🙏."
    ),
    "materi": (
        "Bismillah Bapak/Ibu 🙏😊, materi *Kelas Online Bimbingan Om Budi* berfokus pada perbaikan tauhid, vibrasi energi batin, dan ikhtiar langit untuk mengurai sumbatan rezeki.\n\n"
        ...
        "Semua materi dirancang praktis agar bisa langsung diamalkan dalam kehidupan sehari-hari ya 😊🙏."
    ),
    "proposal doa": (
        ...
        "Semoga Allah mengijabah setiap butir hajat yang Bapak/Ibu ikhtiarkan ya 🤲🙏."
    ),
    "mindset": (
        ...
        "Tetap jaga kebersihan hati dan optimisme dalam berikhtiar langit ya 😊🙏."
    ),
    "dhuha": (
    ...
    "sholawat": (
        ...
        "Dawamkan dengan hati yang hadir dan penuh cinta kepada Rasulullah SAW ya 🙏."
    ),
    "tahajjud": (
...
ATURAN MENJAWAB:
1. Persona: Islami, bijak, hangat, penuh empati, menyejukkan batin, dan selalu menyertakan emoji sungkem (🙏) dan senyum (😊).
2. Jika user mengeluh soal hutang yang belum lunas atau masalah hidup, beri empati mendalam dan jelaskan pembersihan sumbatan batin.
3. Panjang Teks: Proporsional (2-3 paragraf terstruktur, sekitar 120-180 kata).
...
{message}"""
        ...
        if groq_key:
            try:
                ...
                groq_payload = {
                    ...
                    "messages": [
                        {"role": "system", "content": "Anda adalah Asisten AI Bimbingan Om Budi yang bijak, ramah, hangat dengan emoji sungkem 🙏 dan senyum 😊."},
        ...
        # 3. Dynamic Knowledge Rule Fallback
        ...
        # 4. Fallback Santun & Menenangkan dengan Emoji Sungkem & Senyum
        return (
            f"Assalamu'alaikum Warahmatullahi Wabarakatuh Bapak/Ibu *{user_name}* 🙏😊\n\n"
            "Mohon maaf yang sebesar-besarnya, untuk saat ini sistem asisten otomatis kami belum dapat memberikan jawaban secara lengkap atas pertanyaan/kondisi yang Bapak/Ibu sampaikan 🙏\n\n"
            "Pesan dan pertanyaan Bapak/Ibu sudah kami tampung dengan baik ke dalam catatan tim bimbingan 😊. Semoga Allah SWT senantiasa memberikan kemudahan, kelapangan hati, serta jalan keluar terbaik atas setiap ikhtiar dan urusan Bapak/Ibu sekeluarga. Aamiin ya Rabbal 'Alamin 🤲🙏\n\n"
            "_Bapak/Ibu juga dapat mendiskusikan hal ini secara langsung pada sesi Zoom Booster bersama Om Budi setiap Rabu malam ya 😊_"
        )
    ...
    async def handle_incoming_message(
        ...
        if image_bytes:
            ...
            if ocr_res.get("is_valid_receipt"):
                ...
                reply = (
                    ...
                    "Tautan Group Khusus Zoom Booster (setiap Rabu malam) akan segera kami kirimkan ke nomor ini ya 😊."
                )
        ...
        if button_id == "btn_sub_1_g":
            return {"type": "buttons", "reply": "🤝 *Jika Tidak Bisa Hadir Live*\n\nTidak perlu khawatir ya 😊, Bapak/Ibu tetap bisa menyimak siaran ulang rekaman dan tetap mendawamkan amalan riyadhoh secara mandiri 🙏.", "buttons": zoom_nav_buttons}
