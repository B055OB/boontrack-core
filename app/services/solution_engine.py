    ...
    async def find_solution(self, user_message: str = "") -> Dict[str, Any]:
        try:
            ...
            sys_prompt = (
                ...
                "ATURAN ALUR INTERVIEW (SANGAT KETAT & SEQUENTIAL):\n"
                "Analisislah input pengguna dan berikan respon yang sesuai tahapannya:\n\n"
                "1. Jika pengguna mengetik angka '1' saja:\n"
                "   -> Tanya: 'Siap, mari kita buat/perbarui CV kamu! Pertama-tama, boleh tahu siapa nama lengkap kamu?'\n\n"
                "2. Jika pengguna memberikan NAMA LENGKAP (misal: 'Rayi GEMilang'):\n"
                "   -> Tanya: 'Salam kenal! Selanjutnya, posisi atau bidang pekerjaan apa yang ingin kamu lamar?'\n\n"
                "3. Jika pengguna menyebut POSISI / BIDANG (misal: 'Auditor', 'Digital Marketing'):\n"
                "   -> Tanya: 'Oke, bidang tersebut sangat menarik! Apa pendidikan terakhir kamu (Nama kampus/sekolah & jurusan)?'\n\n"
                "4. Jika pengguna menyebut PENDIDIKAN (misal: 'S1 ITB Akuntansi'):\n"
                ...
                "5. Jika pengguna menyebut PENGALAMAN / 'BELUM PERNAH' (misal: 'belum pernah', 'Gojek'):\n"
                "   -> Tanya: 'Catatan pengalaman/organisasi dicatat! Terakhir, apa saja keahlian/skill utama, software, atau sertifikasi yang kamu miliki?'\n\n"
                "6. Jika pengguna menyebut KEAHLIAN / SKILL / HARD SKILL (misal: 'koding', 'python', 'excel', 'koding next', 'pajak'):\n"
                "   -> DILARANG KERAS RESET ATAU MENANYAKAN NAMA KEMBALI!\n"
                "   -> LANGSUNG BUATKAN DRAFT SUSUNAN CV LENGKAP RAPI DENGAN FORMAT MARKDOWN (Ringkasan Profil, Pendidikan, Pengalaman, Skill).\n"
                "   -> Akhiri dengan kalimat: 'Ini dia draft struktur CV kamu! Ada bagian yang mau ditambah atau disesuaikan lagi?'\n\n"
                "ATURAN UTAMA: Kata seperti 'next', 'lanjut', 'oke' jika diketik saat pengisian skill, ANGGAP SEBAGAI PENGISIAN SKILL dan LANGSUNG TAMPILKAN DRAFT CV KESELURUHAN."
            )
