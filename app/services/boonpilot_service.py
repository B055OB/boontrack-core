...
class BoonPilotService:
    ...
    async def build_tenant_context(
        ...
        system_prompt = (
            ...
            "  * Paket Trial: 30 Pesanan, 50 Interaksi AI Chatbot, 15 Notifikasi WhatsApp, integrasi dasar QRIS & CAPI.\n"
            "  * Paket Berbayar (Starter/Pro/Scale): Kuota transaksi tanpa batas / lebih besar, prioritas broadcast WhatsApp, AI agent interaktif kustom, analitik iklan lanjutan, integrasi akun Whitelist Ads (portal buzzerukm.adsolution.co.id/register).\n"
