...
class BrainEngine:
  ...
  async def handle_message(
    ...
    # 3. Deteksi Goal/Intent Baru (Hybrid Match)
    ...
    if self.ai_gateway:
      try:
        # Panggil AI Gateway dengan konteks session
    ...
    return {
        "text": (
            "Saya siap bantu kamu sampai dapat kerja! Pilih langkah pertama"
            " kamu:\n\n1️⃣ Ketik **'Bikin CV'** untuk buat CV ATS-friendly\n2️⃣"
            " Ketik **'Latihan Interview'** untuk simulasi wawancara\n3️⃣ Ketik"
            " **'Curhat'** kalau lagi merasa mentok/stres cari kerja"
        )
    }
    ...
    # FLOW STEP 2: KONTAK -> TANYA TARGET POSISI (Progress 3/6)
      ...
      return {
          "text": (
              ...
              "**Posisi/pekerjaan apa** yang sedang kamu incar? (Contoh: *Admin"
              " Sales, Digital Marketer, Software Engineer*)"
          )
      }